  ...
  render() {
    return (
        <BrowserRouter>
          ...
          <div>
          <Routes>
            <Route exact path="/allnews" element={<News key="general" pageSize={this.pageSize} country="in" category="general" />}> </Route>
            ...
            <Route exact path="/sports" element={<News key="sport" pageSize={this.pageSize} country="in" category="sport" />}>  </Route>
